...
//   return (
//     // <div className="bg-gray-100 w-[180px] h-[40px] rounded-sm">
//     //   <div className="mt- flex items-center justify between gap-2 md:mt-8">
...
export function SearchReservationsSkeleton() {
  return (
    <div className="flex flex-grow rounded-lg bg-gray-100 py-[20px] py-[20px] pl-10 text-sm">
    </div>
  )
}
...
export function CreateReservationsSkeleton() {
  return (
    <div
      className="flex flex-wrap h-8 w-1/6 items-center rounded-lg bg-gray-100 py-[20px] text-sm font-medium text-white">
    </div>
  )
}
...
export function SearchCustomersSkeleton() {
  return (
    <div className="flex flex-grow rounded-lg bg-gray-100 py-[20px] py-[20px] pl-10 text-sm">
    </div>
  )
